...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100)#!/usr/bin/sage
...
coeffs_array = coeffs_string.split("c")[_sage_const_1 :]

# Turn array into a string representation of the polynomial
degree = len(coeffs_array) - _sage_const_1 
poly_string = ""
...
if (poly.is_monic()):
    if (poly.is_irreducible()):
        F = NumberField(poly, names=('alpha',)); (alpha,) = F._first_ngens(1)
    else:
...
new_filename = 'pickled/' + original_coeffs_string + '-' + thread_id + '-' + str(starting_index + _sage_const_100 )

# If someone has just opened the page, copy the pickled data for the
# default polynomial instead of recomputing it
if coeffs_array == [_sage_const_1 ,-_sage_const_5 ,_sage_const_6 ,_sage_const_2 ,_sage_const_4 ,_sage_const_1 ,-_sage_const_3 ,-_sage_const_2 ,_sage_const_1 ] and starting_index == _sage_const_0 :
...
for i in range(starting_index, starting_index + _sage_const_100 ):
    ...
    for j in range(r):
        print '\mathfrak{p}_{' + str(j+_sage_const_1 ) + '}',
        # replace with ternary?
        if(e[j] > _sage_const_1 ):
            print '^{' + str(e[j]) + '}',
    print '\]</p>\n'
    ...
    print '    <p>\[\\begin{align*}'
    for j in range(r):
        print '        |\mathcal{O}_F/\mathfrak{p}_{' + str(j+_sage_const_1 ) + '}| &= ' + str(Z_prime),
        # replace with ternary?
        if(f[j] > _sage_const_1 ):
            print '^{' + str(f[j]) + '}',
        if (j != r-_sage_const_1 ):
            print r"\\"
    print '\n        \end{align*}\]</p>'
    ...
    for j in range(r):
        ...
        print '         \mathfrak{p}_{' + str(j+_sage_const_1 ) + '}=\,&\\textstyle' + explicit
        if (j != r-_sage_const_1 ):
            print r"\\"
    print '\n        \end{align*}\]</p>'
